...
goog.addDependency("../../../ydn-base/js/client/client.js", ['ydn.client', 'ydn.client.Client', 'ydn.client.HttpRequest', 'ydn.client.HttpRequestData', 'ydn.client.HttpRespondData'], ['goog.net.XhrManager']);
goog.addDependency("../../../ydn-base/js/client/gapi-client.js", ['ydn.client.GapiClient'], ['ydn.client', 'ydn.client.SimpleClient']);
goog.addDependency("../../../ydn-base/js/client/simple-client.js", ['ydn.client.SimpleClient'], ['ydn.client', 'ydn.client.SimpleHttpRequest']);
goog.addDependency("../../../ydn-base/js/client/simple-request.js", ['ydn.client.SimpleHttpRequest'], ['goog.Uri', 'ydn.client']);
...
goog.addDependency("../../../ydn-base/js/ydn/buffer.js", ['ydn.structs.Buffer', 'ydn.structs.Buffer.Iterator'], ['goog.structs.AvlTree', 'ydn.db.KeyRange']);
goog.addDependency("../../../ydn-base/js/ydn/error.js", ['ydn.error', 'ydn.error.ArgumentException', 'ydn.error.NotImplementedException', 'ydn.error.ConstraintError', 'ydn.error.NotSupportedException', 'ydn.error.InternalError', 'ydn.error.InvalidOperationException', 'ydn.error.InvalidOperationError'], []);
goog.addDependency("../../../ydn-base/js/ydn/expression.js", ['ydn.math.Expression'], ['ydn.string', 'goog.string', 'ydn.object', 'ydn.error']);
goog.addDependency("../../../ydn-base/js/ydn/json.js", ['ydn.json'], ['goog.debug.Logger', 'goog.json']);
...
goog.addDependency("../../../ydn-base/js/ydn/debug/error.js", ['ydn.debug.error.ArgumentException', 'ydn.debug.error.InternalError', 'ydn.debug.error.InvalidOperationException', 'ydn.debug.error.NotImplementedException', 'ydn.debug.error.NotSupportedException', 'ydn.debug.error.ConstraintError'], ['goog.debug.Error']);
...
goog.addDependency("../../../ydn-base/js/ydn/object/merge.js", ['ydn.object.merge'], ['ydn.string.diff']);
