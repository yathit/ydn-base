...
goog.addDependency("../../../ydn-base/js/http/gapi_request_adapter.js", ['ydn.http.GapiRequestAdapter'], ['ydn.http.ITransport']);
...
goog.addDependency("../../../ydn-base/js/http/transport.js", ['ydn.http.ITransport', 'ydn.http.CallbackResult'], []);
goog.addDependency("../../../ydn-base/js/http/xmlhttpreq_transport.js", ['ydn.http.XMLHttpRequest'], ['ydn.http.ITransport', 'ydn.http', 'goog.object', 'goog.Uri', 'ydn.debug.error.ArgumentException']);
goog.addDependency("../../../ydn-base/js/ydn/async.js", ['ydn.async'], ['goog.async.Deferred', 'goog.async.DeferredList']);
goog.addDependency("../../../ydn-base/js/ydn/debug.js", ['ydn.debug', 'ydn.debug.error.ArgumentException', 'ydn.debug.error.NotSupportedException'], ['goog.debug.Console', 'goog.debug.Logger', 'goog.debug.LogManager', 'goog.debug.DivConsole']);
